...
SECRET_KEY = 'django-insecure-!b5613r(cgaz*sd^&@^#p=08k$yshvgk9thgp$#-b-%)&7bi=-'
...
# 支持两种静态文件路径：/static/ 和 /apipy/static/
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'assets'),  # 添加assets目录到静态文件搜索路径
]
...
# Channels 配置：开发环境使用内存通道层（不建议用于生产）
CHANNEL_LAYERS = {
    "default": {
